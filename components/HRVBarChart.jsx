    ...
    <View className="bg-[#1e2a47] rounded-2xl p-6 mx-4 mb-6 shadow-lg">
      ...
      <View className="flex-row items-center justify-between mb-4">
        <View className="flex-row items-center">
          <View className="w-12 h-12 bg-[#6366ff]/20 rounded-xl items-center justify-center mr-3">
            <Feather name="activity" size={24} color="#6366ff" />
          </View>
          <View>
      ...
      <View className="flex-row justify-between mb-6 bg-[#2a2a4a]/50 rounded-xl p-4">
        <View className="items-center">
          ...
          <Text className="mt-1 text-xl font-bold text-white">47.3</Text>
          <Text className="text-[#8a94a6] text-xs">ms</Text>
        </View>
        ...
        <View className="items-center">
          ...
          <Text className="mt-1 text-xl font-bold text-green-400">50.0</Text>
          <Text className="text-[#8a94a6] text-xs">ms</Text>
        </View>
        <View className="w-px bg-[#3a3a5a]" />
        <View className="items-center">
          ...
          <Text className="mt-1 text-xl font-bold text-orange-400">45.0</Text>
          <Text className="text-[#8a94a6] text-xs">ms</Text>
        </View>
      </View>
      ...
      <View className="bg-[#1a1f3a] rounded-xl p-4 -mx-2">
        <BarChart
          ...
          chartConfig={{
            ...
            decimalPlaces: 1,
            color: (opacity = 1) => `rgba(99, 102, 255, ${opacity})`,
      ...
      <View className="flex-row items-center mt-4">
        <View className="w-2 h-2 bg-[#6366ff] rounded-full mr-2" />
        <Text className="text-[#8a94a6] text-xs flex-1">
          Una mayor variabilidad indica mejor recuperación y menor estrés
        </Text>
      </View>
    </View>
  );
